...
import { conversationTurn, createConversationState, vehicleLabel, vehicleCandidateOptions } from "./smart-consult-conversation.js?v=operational-v1";
import { findEntry, entryState } from "./smart-consult-entry.js?v=operational-v1";
import { LAUNCHER_KEY, decodeLauncherContext, hasEntryConflict } from "./smart-consult-launcher-context.js";
import { SESSION_KEY, encodeSession, decodeSession, clearSession, safeUserMessage, summaryFields } from "./smart-consult-session.js?v=operational-v1";
