...
const evidenceDir=process.argv.includes('--location')?'docs/evidence/location-nlu/regression':process.argv.includes('--product')?'docs/evidence/product-as-hours':'docs/evidence/brand-service';
