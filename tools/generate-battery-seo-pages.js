...
const FIXED_TOPICS = [
  {
    ...
    description: "자동차배터리 가격, 교체비용, 수명, AGM배터리와 차량별 적용 배터리 상담 정보를 한곳에서 확인하세요.",
    h1: "자동차배터리 정보 가이드",
    summaryTitle: "배터리 확인 전 알아두면 좋은 핵심",
    summaryItems: ["차량별 적용 배터리 확인", "일반 DIN과 AGM 구분", "가격과 교체비용 확인", "방전과 수명 상담", "출장배터리 서비스지역 연결"],
    directQuestion: "자동차배터리는 어떤 순서로 확인하면 좋나요?",
    directAnswer: "먼저 차량의 제조사, 차량명, 연식, 연료, 세부모델을 확인하고 적용 배터리를 보는 것이 좋습니다. 그다음 일반 DIN 또는 AGM 여부와 현재 판매가격, 출장교체 방문 시간을 함께 확인하면 상담이 더 정확해집니다.",
    sections: [
      ["차량별 적용 배터리 확인", "자동차배터리는 같은 차량명이라도 연식과 세부모델에 따라 적용 배터리가 달라질 수 있습니다. 일등밧데리 차량 DB는 세부모델별 기본 배터리와 업그레이드 배터리를 구분해 안내합니다."],
      ["가격 확인 흐름", "배터리 가격은 용량과 타입, 제품에 따라 달라집니다. 차량에 맞는 적용 배터리를 먼저 확인한 뒤 일반 DIN 또는 AGM 상품의 현재 판매가격을 확인하는 흐름이 안전합니다."],
      ["교체 시점 판단", "시동이 약하거나 방전이 반복되면 단순 충전으로 끝내기보다 배터리 상태와 차량 사용환경을 함께 점검해야 합니다."],
      ["출장배터리 상담", "저희 일등밧데리는 서울·경기·인천의 공식 서비스지역에서 자동차배터리 출장교체 서비스를 제공합니다. 방문 시간은 당일 기사 배차와 교통 상황을 확인해 안내합니다. 차량 위치와 주차 환경을 함께 알려주세요."],
    ...
    faqs: [
      ["내 차에 맞는 자동차배터리는 어떻게 확인하나요?", "차량 배터리 찾기에서 제조사, 차량명, 세부모델을 선택하면 DB에 등록된 기본 배터리와 업그레이드 배터리를 확인할 수 있습니다."],
      ["배터리 가격은 왜 차량마다 다른가요?", "적용 배터리, 용량, AGM 여부, 제품에 따라 가격이 달라질 수 있습니다. 차량별 배터리 확인 후 현재 판매가격을 확인하는 것이 좋습니다."],
      ["출장배터리 교체도 가능한가요?", "저희 일등밧데리는 서울·경기·인천의 공식 서비스지역에서 자동차배터리 출장교체 서비스를 제공합니다. 방문 시간은 당일 기사 배차와 교통 상황을 확인해 안내합니다."],
  ...
  },
  {
    ...
    eyebrow: "Car Battery",
    title: "자동차배터리 선택 안내 | 자동차밧데리 | 일등밧데리",
    description: "자동차배터리와 자동차밧데리 검색 고객을 위한 차량용배터리 선택 기준, DIN, AGM, 용량 확인 방법 안내입니다.",
    h1: "자동차배터리 선택 안내",
    summaryTitle: "차량용배터리 확인 포인트",
    summaryItems: ["차량마다 다른 적용 배터리", "일반 DIN과 AGM 타입", "용량과 단자 방향 확인", "연식·연료·세부모델 구분", "차량별 DB 바로 연결"],
    directQuestion: "자동차배터리는 어떤 배터리를 선택해야 하나요?",
    directAnswer: "자동차배터리는 차량의 제조사, 연식, 연료, 세부모델과 ISG/AGM 적용 여부 등에 따라 달라집니다. 일등밧데리 차량 DB에서 차량별 기본 배터리와 업그레이드 배터리를 확인할 수 있습니다.",
    sections: [
      ...
      ["자동차밧데리 검색 표현", "자동차밧데리는 자동차배터리를 찾을 때 많이 쓰는 표현입니다. 실제 선택 기준은 검색어가 아니라 차량별 적용 배터리입니다."],
      ["가격과 교체 연결", "적용 배터리를 확인한 뒤 가격 페이지와 출장교체 상담을 함께 확인하면 제품 선택과 교체 일정을 더 쉽게 정리할 수 있습니다."]
    ],
    related: ["price", "replacement", "batteryLife", "agm", "mobile", "importCar"],
    faqs: [
      ["자동차배터리와 자동차밧데리는 다른가요?", "표현만 다를 뿐 일반적으로 같은 의미로 사용됩니다. 중요한 것은 차량에 맞는 배터리와 타입을 확인하는 것입니다."],
      ["같은 차종이면 배터리도 같나요?", "같은 차량명이라도 연식, 연료, 세부모델에 따라 적용 배터리가 달라질 수 있습니다."],
  ...
  },
  {
    ...
    description: "자동차배터리교체 시기, 배터리교체 전 확인할 증상, 차량별 적용 배터리 확인과 출장교체 상담 흐름을 안내합니다.",
    h1: "자동차배터리 교체 안내",
    summaryTitle: "교체 전 확인할 내용",
    summaryItems: ["시동 성능 저하", "반복 방전 여부", "차량별 교체 배터리 확인", "AGM 적용 여부", "출장교체 서비스 지역"],
    ...
    sections: [
      ...
      ["교체 배터리 확인", "자동차배터리 교체는 차량에 맞는 배터리 선택이 먼저입니다. 제조사, 차량명, 연식, 세부모델을 기준으로 확인합니다."],
      ["AGM 차량 주의", "AGM 배터리가 적용된 차량은 일반 배터리와 다른 교체 판단이 필요할 수 있습니다. 기존 적용 타입을 먼저 확인합니다."],
      ["출장 교체 흐름", "저희 일등밧데리는 서울·경기·인천의 공식 서비스지역에서 자동차배터리 출장교체 서비스를 제공합니다. 차량 위치와 적용 배터리를 확인한 뒤 방문 시간을 안내합니다."],
    ...
    faqs: [
      ...
      ["출장배터리 교체가 가능한가요?", "저희 일등밧데리는 서울·경기·인천의 공식 서비스지역에서 자동차배터리 출장교체 서비스를 제공합니다. 방문 시간은 당일 기사 배차와 교통 상황을 확인해 안내합니다."],
  ...
  },
  {
    ...
    directAnswer: "자동차배터리 가격은 적용 배터리, 용량, 일반 DIN 또는 AGM 여부와 제품에 따라 달라집니다. 차량별 적용 배터리를 먼저 확인한 뒤 현재 판매가격을 확인하는 것이 정확합니다.",
    sections: [
      ["가격을 먼저 보면 안 되는 이유", "같은 차량명이라도 적용 배터리가 다를 수 있어 가격보다 차량별 배터리 확인이 먼저입니다."],
    ...
    faqs: [
      ["자동차배터리 가격을 바로 알 수 있나요?", "차량에 맞는 배터리를 먼저 확인한 뒤 일반 DIN 또는 AGM 상품 바로가기에서 현재 판매가격을 확인할 수 있습니다."],
  ...
  },
  {
    ...
    summaryItems: ["배터리 제품 가격", "차량별 작업 조건", "출장교체 서비스 지역", "수입차 코딩 가능성", "현장 결제 상담"],
    directQuestion: "자동차배터리 교체비용은 어떻게 결정되나요?",
    directAnswer: "적용 배터리와 제품, 차량 구조, 수입차 코딩 여부, 출장교체 조건 등에 따라 달라질 수 있습니다. 정확한 비용은 차량 정보를 확인한 후 안내합니다.",
    sections: [
      ["제품 가격", "교체비용의 기본은 차량에 맞는 배터리 제품 가격입니다. 일반 DIN과 AGM 여부에 따라 선택지가 달라집니다."],
      ["차량 조건", "배터리 위치, 단자 구조, 차량 전력관리 방식에 따라 작업 확인 내용이 달라질 수 있습니다."],
      ["출장 조건", "공식 서비스지역에서 출장교체를 제공하며, 차량 위치와 현장 진입 조건을 확인해 방문 시간과 작업 준비사항을 안내합니다."],
  ...
  },
  {
    ...
    description: "출장배터리 서비스는 차량 위치와 차종, 적용 배터리를 확인한 뒤 서울·경기·인천 방문 교체 상담을 안내합니다.",
    h1: "출장배터리 교체 안내",
    summaryTitle: "출장배터리 상담 흐름",
    summaryItems: ["차량 위치 확인", "차종과 교체 배터리 확인", "출장교체 서비스지역 안내", "방문 일정 상담", "현장 교체와 기본 확인"],
    directQuestion: "출장배터리 교체는 어떻게 진행되나요?",
    directAnswer: "저희 일등밧데리는 서울·경기·인천의 공식 서비스지역에서 자동차배터리 출장교체 서비스를 제공합니다. 차량 위치와 차종, 적용 배터리를 확인한 뒤 방문 시간을 안내하고 차량이 있는 위치에서 배터리를 교체합니다.",
    sections: [
      ["차량 위치 상담", "출장배터리는 차량이 있는 위치를 기준으로 상담합니다. 서울, 경기, 인천 지역 내에서도 일부 현장 조건은 확인이 필요합니다."],
      ["차종 확인", "제조사와 차량명, 연식, 세부모델을 확인하면 필요한 교체 배터리를 더 정확히 안내할 수 있습니다."],
      ["방문 일정", "방문 시간은 당일 기사 배차와 교통 상황을 확인해 안내합니다."],
    ...
    faqs: [
      ["출장배터리 서비스 지역은 어디인가요?", "저희 일등밧데리는 서울·경기·인천의 공식 서비스지역에서 자동차배터리 출장교체 서비스를 제공합니다. 상세 지역은 지역별 출장배터리 페이지와 서비스 지역 안내에서 확인하실 수 있습니다."],
      ["차량 위치만 알려주면 되나요?", "차량 위치와 함께 제조사, 차량명, 연식, 연료 정보를 알려주시면 더 정확한 안내가 가능합니다."],
      ["현장에서 결제할 수 있나요?", "현장 카드, 현금, 이체 결제 가능 여부는 상담 시 최종 안내됩니다."],
      ["출장배터리교체 비용은 어떻게 확인하나요?", "적용 배터리와 위치, 작업 조건에 따라 달라질 수 있어 1644-9141 상담으로 확인해 주세요."]
    ]
  },
  {
    id: "discharge",
    ...
    summaryItems: ["반복 방전 여부", "블랙박스 상시전원", "충전계통 확인 가능성", "교체 배터리 확인", "출장교체 상담"],
    directQuestion: "자동차 배터리가 방전되면 어떻게 해야 하나요?",
    directAnswer: "반복 방전이나 시동 불량이 발생하면 단순 충전뿐 아니라 배터리 상태와 차량 충전계통을 함께 확인하는 것이 좋습니다. 배터리 교체가 필요한 경우 차량에 맞는 제품을 선택해야 합니다.",
    sections: [
      ...
      ["교체 판단", "배터리 상태가 좋지 않거나 방전이 반복되면 차량에 맞는 배터리로 교체 상담을 받을 수 있습니다."],
      ["출장 상담", "저희 일등밧데리는 서울·경기·인천의 공식 서비스지역에서 자동차배터리 출장교체 서비스를 제공합니다. 차량 이동이 어려운 방전 상황에서는 차량 위치를 확인해 방문 시간을 안내합니다."]
    ],
    ...
    faqs: [
      ...
      ["방전 차량도 출장 상담이 가능한가요?", "저희 일등밧데리는 서울·경기·인천의 공식 서비스지역에서 자동차배터리 출장교체 서비스를 제공합니다. 차량 위치와 차종을 확인한 뒤 방문 시간을 안내합니다."],
  ...
  },
  {
    ...
    sections: [
      ...
      ["차량 DB 연결", "일등밧데리 차량 DB에 등록된 수입차 제조사 허브에서 차량별 배터리 가격 및 교체 페이지를 확인할 수 있습니다."],
      ["출장 상담", "저희 일등밧데리는 공식 서비스지역에서 수입차 배터리 출장교체를 제공합니다. 차량 정보와 현장 조건을 확인한 뒤 1644-9141 전화상담으로 방문 시간을 안내합니다."]
    ],
    related: ["agm", "agmPrice", "replacementCost", "mobile", "price", "carBattery"],
    faqs: [
      ["수입차 배터리는 모두 AGM인가요?", "아닙니다. AGM 적용 차량이 많지만 차종과 연식에 따라 다르므로 차량별 적용 배터리 확인이 필요합니다."],
      ["수입차는 코딩이 꼭 필요한가요?", "모든 수입차가 반드시 코딩이 필요한 것은 아니며 차종에 따라 필요할 수 있습니다."],
      ["수입차 출장배터리 상담도 가능한가요?", "차량 위치와 차종, 적용 배터리를 확인한 뒤 상담을 안내합니다."],
      ["수입차 배터리 가격은 어디서 확인하나요?", "차량별 적용 배터리를 먼저 확인하고 AGM 또는 일반 DIN 상품의 현재 판매가격을 확인해 주세요."]
    ],
  ...
  },
  {
    ...
    eyebrow: "Delkor",
    title: "델코배터리 선택 안내 | 자동차배터리 | 일등밧데리",
    description: "델코배터리 선택 전 차량 적용 배터리, 일반 DIN과 AGM 구분, 용량, 현재 판매가격 확인 방법을 안내합니다.",
    h1: "델코배터리 선택 안내",
    summaryTitle: "브랜드보다 먼저 볼 기준",
    summaryItems: ["차량 호환 규격", "일반 DIN과 AGM 구분", "용량 확인", "현재 판매가격", "출장교체 상담"],
    directQuestion: "델코배터리는 어떻게 선택해야 하나요?",
    directAnswer: "델코배터리를 선택할 때도 브랜드명보다 차량에 맞는 배터리, 용량, 일반 DIN 또는 AGM 여부를 먼저 확인해야 합니다. 차량 DB에서 적용 배터리를 확인한 뒤 제품을 선택하는 것이 안전합니다.",
    sections: [
    ...
    faqs: [
      ["델코배터리는 어떤 차량에 맞나요?", "차량별 적용 배터리와 제품 타입이 맞아야 하므로 제조사, 차량명, 세부모델 기준으로 확인해야 합니다."],
      ["델코 AGM 배터리도 있나요?", "AGM 배터리 관련 안내는 델코 AGM 배터리 페이지에서 별도로 확인할 수 있습니다."],
      ["브랜드만 같으면 장착 가능한가요?", "브랜드가 같아도 용량, 타입, 단자 방향 등 규격이 맞아야 합니다."],
      ["델코배터리 가격은 어디서 보나요?", "차량에 맞는 배터리를 확인한 뒤 일반 DIN 또는 AGM 상품 바로가기에서 현재 판매가격을 확인해 주세요."]
    ]
  },
  {
    id: "agm",
    ...
    image: "agm.png",
    eyebrow: "AGM",
    title: "AGM배터리 선택 안내 | 자동차 AGM 배터리 | 일등밧데리",
    description: "AGM배터리란 무엇인지, 일반 배터리와 차이, 적용 차량, 가격 확인과 차량별 적용 배터리 확인 방법을 안내합니다.",
    h1: "AGM배터리 선택 안내",
    summaryTitle: "AGM 확인 핵심",
    summaryItems: ["ISG와 전장장비", "일반 배터리와 차이", "수입차 적용 가능성", "차량별 적용 배터리 확인", "용량별 적용 차량"],
    ...
    faqs: [
      ...
      ["AGM 차량에 일반 배터리를 장착해도 되나요?", "충전제어 환경에 맞지 않을 수 있어 차량별 적용 배터리 확인과 상담을 권장합니다."],
  ...
  },
  {
    ...
    description: "AGM배터리 가격은 용량, 차량 적용 배터리, 제품에 따라 달라집니다. 현재 판매가격과 차량별 적용 배터리 확인 방법을 안내합니다.",
    h1: "AGM배터리 가격 안내",
  ...
  },
  {
    ...
    sections: [
      ["차량 호환 우선", "브랜드보다 차량 적용 배터리, 용량, AGM 적용 여부가 먼저입니다."],
  ...
  },
  {
    ...
    sections: [
      ...
      ["출장 상담", "저희 일등밧데리는 서울·경기·인천의 공식 서비스지역에서 자동차배터리 출장교체 서비스를 제공합니다. 차량 위치와 차종을 알려주시면 방문 시간을 안내해드립니다."]
    ],
  ...
  const areaLinks = includeArea
    ? `
          <a class="topic-card" href="/area/index.html">
            ...
            <span>서울·경기·인천 출장교체 서비스 지역 보기 →</span>
          </a>`
    : "";
  ...
  return `
      <section class="section">
        <div class="section-heading">
          ...
          <p class="section-desc">저희 일등밧데리는 서울·경기·인천의 공식 서비스지역에서 자동차배터리 출장교체 서비스를 제공합니다. 방문 시간은 당일 기사 배차와 교통 상황을 확인해 안내합니다.</p>
        </div>
        <div class="topic-grid">
          <a class="topic-card" href="/car-battery/index.html">
            <strong>차량별 배터리 가격 및 교체</strong>
  ...
  return `
      <section class="section">
        ...
        <div class="topic-grid">
          ...
          <a class="topic-card" href="/area/index.html"><strong>지역별 전체 보기</strong><span>출장교체 서비스 지역 허브 →</span></a>
        </div>
      </section>`;
}
  ...
  manufacturers.forEach((manufacturer) => {
    ...
    fs.readdirSync(dir, { withFileTypes: true })
      ...
      .forEach((entry) => {
        ...
        const label = h1.replace(/\s*배터리\s*가격\s*및\s*(?:규격|교체)\s*안내\s*$/, "").trim();
...
function renderCapacityPage({ capacity, rows }, vehiclePageMap, blogCases) {
  ...
  const topic = {
    ...
    faqs: [
      ...
      ["출장교체 상담도 가능한가요?", "저희 일등밧데리는 서울·경기·인천의 공식 서비스지역에서 자동차배터리 출장교체 서비스를 제공합니다. 차량 위치와 차종을 확인한 뒤 1644-9141로 방문 시간을 안내합니다."]
    ]
  };
  const blogCaseSection = renderBlogCaseSection(getBlogCasesForPage(blogCases, {
