...
const FIXED_TOPICS = [
  {
    ...
    summaryItems: ["차량별 적용 배터리 확인", "일반 DIN과 AGM 구분", "가격과 교체비용 확인", "방전과 수명 상담", "출장배터리 가능지역 연결"],
    directQuestion: "자동차배터리는 어떤 순서로 확인하면 좋나요?",
    directAnswer: "먼저 차량의 제조사, 차량명, 연식, 연료, 세부모델을 확인하고 적용 배터리를 보는 것이 좋습니다. 그다음 일반 DIN 또는 AGM 여부와 현재 판매가격, 출장교체 가능 여부를 함께 확인하면 상담이 더 정확해집니다.",
    sections: [
  ...
  },
  {
    ...
    summaryItems: ["시동 성능 저하", "반복 방전 여부", "차량별 교체 배터리 확인", "AGM 적용 여부", "출장교체 가능 지역"],
    ...
    sections: [
      ...
      ["출장 교체 흐름", "차량 위치와 적용 배터리를 상담한 뒤 서비스 가능지역과 방문 일정을 안내합니다."],
  ...
  },
  {
    ...
    summaryItems: ["차량 위치 확인", "차종과 교체 배터리 확인", "서비스 가능지역 확인", "방문 일정 상담", "현장 교체와 기본 확인"],
    directQuestion: "출장배터리 교체는 어떻게 진행되나요?",
    directAnswer: "차량 위치와 차종, 적용 배터리를 확인한 뒤 서비스 가능지역과 방문 일정을 상담하고 차량이 있는 위치에서 배터리 교체를 진행합니다.",
    sections: [
