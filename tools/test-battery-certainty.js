...
const evidenceDir=process.argv.includes('--product')?'docs/evidence/product-as-hours':process.argv.includes('--brand')?'docs/evidence/brand-service':process.argv.includes('--pricing')?'docs/evidence/battery-pricing':process.argv.includes('--continuation')?'docs/evidence/db-driven-flow':'docs/evidence/battery-certainty';
