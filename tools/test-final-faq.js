...
assert.deepEqual({...policy,version:old.version,finalFaq:undefined},{...old,finalFaq:undefined},'existing policy unchanged');
assert.deepEqual(policy.finalFaq.facts,{CARD_PAYMENT_AVAILABLE:true,CASH_RECEIPT_AVAILABLE:true,TAX_INVOICE_AVAILABLE:true,BANK_TRANSFER_AVAILABLE:true,DIRECT_VISIT_AVAILABLE:true,VISIT_REQUIRES_PRECONFIRMATION:true,BATTERY_REPLACEMENT_TYPICAL_MINUTES_MIN:10,BATTERY_REPLACEMENT_TYPICAL_MINUTES_MAX:20,WORK_TIME_CAN_VARY:true});
const groups={
