...
const evidenceDir=process.argv.includes('--location')?'docs/evidence/location-nlu/regression':process.argv.includes('--product')?'docs/evidence/product-as-hours':process.argv.includes('--brand')?'docs/evidence/brand-service':'docs/evidence/battery-pricing';
